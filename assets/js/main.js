...
//         var slideWidth = $(this.ID+' ul li').width();
//         var slideHeight = $(this.ID+' ul li').height();
//         var sliderUlWidth = slideCount * slideWidth;

//         $(this.ID+'').css({ width: slideWidth, height: slideHeight });

//         $(this.ID+' ul').css({ width: sliderUlWidth, marginLeft: - slideWidth });

//         $(this.ID+' ul li:last-child').prependTo(this.ID+' ul');

//         $(this.ID+'_prev').click(function () {
//             moveL();
//         });
    
//         $(this.ID+'_next').click(function () {
//             moveR();
//         });
//     }
...
//             left: - slideWidth
//         }, 200, function () {
//             $(this.ID+' ul li:first-child').appendTo(this.ID+' ul');
//             $(this.ID+' ul').css('left', '');
//         });
//     }
// }
